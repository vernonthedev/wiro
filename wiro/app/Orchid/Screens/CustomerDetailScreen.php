...
class CustomerDetailScreen extends Screen
{
    ...
    public function layout(): iterable
    {
        return [
            ...
            Layout::tabs([
                'Personal Info' => Layout::legend('borrower', [
                ...
                'Residential Info' => Layout::legend('borrower', [
                ...
                'Business/Employment Info' => Layout::legend('borrower', [
                ...
                'Next of Kin Info' => Layout::legend('borrower', [
